...
use App\Http\Controllers\Admin\ChargePointController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth:admin', ShareAdminData::class])->group(function () {
        ...
        // Services management (CRUD only for services)
        ...
        Route::resource('charge-points', ChargePointController::class)->only(['index', 'store', 'update', 'destroy']);

        // Session management
        Route::get('sessions', [SessionController::class, 'index'])->name('sessions.index');
        Route::get('sessions/active', [SessionController::class, 'active'])->name('sessions.active');
        Route::get('sessions/users', [SessionController::class, 'users'])->name('sessions.users');
        Route::get('sessions/services', [SessionController::class, 'services'])->name('sessions.services');
        Route::get('sessions/charge-points', [SessionController::class, 'chargePoints'])->name('sessions.charge-points');
        ...
        Route::post('sessions/{session}/stop', [SessionController::class, 'stop'])->name('sessions.stop');
