...
export default function BusinessEdit({ business }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/business/${business.id}`);
    };

    return (
        <AdminLayout breadcrumbs={breadcrumbs}>
            <Head title={t('business.edit')} />
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">{t('business.edit')}</h1>
                        <p className="text-muted-foreground">
                            {t('business.editDescription')}
                        </p>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex gap-4 pt-4">
                                <Button type="submit" disabled={processing}>
                                    {processing ? t('forms.saving') : t('business.update')}
                                </Button>
