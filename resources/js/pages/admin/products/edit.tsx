...
import { index as productsIndex, update as productsUpdate } from '@/routes/admin/products';
...
export default function ProductEdit({ product, currencies }: ProductEditProps) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        sku: product.sku || '',
        type: product.type as 'credit',
        price: product.price.toString(),
        currency: product.currency || 'ALL',
        currency_id: product.currency_id?.toString() || '',
        credit_value: product.credit_value?.toString() || '',
        credit_to_currency_rate: product.credit_to_currency_rate.toString(),
        ...
        max_per_transaction: product.max_per_transaction?.toString() || '',
        image_url: product.image_url || '',
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(productsUpdate({ product: product.id }).url);
    };
