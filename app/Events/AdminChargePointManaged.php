...
class AdminChargePointManaged implements ShouldBroadcastNow
{
    use Dispatchable, InteractsWithSockets, SerializesModels;

    public function __construct(
        public ChargePoint $chargePoint,
        public string $action, // 'enabled', 'disabled', 'maintenance', 'reset'
    ...
    {
        return [
            new PrivateChannel('charging.global'), // All users see charge point changes
